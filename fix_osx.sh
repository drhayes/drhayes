...
sudo scutil --set ComputerName "drhayes laptop"
sudo scutil --set HostName "drhayes laptop"
sudo scutil --set LocalHostName "drhayes-laptop"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "drhayes-laptop"
